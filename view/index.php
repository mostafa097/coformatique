                    ...
                    <div class="login-form">
                        <form action="../control/login.php" method="post">
                            <div class="form-group">
                                ...
                                <input class="au-input au-input--full" type="uname" name="uname" id="uname"
                                       placeholder="Email">
                            </div>
                            <div class="form-group">
                            ...
                            <a href="new_user.php" class="au-btn au-btn--block au-btn--green m-b-20"style="text-align: center">Create User</a>
                        </form>
                    </div>
                </div>
            </div>
